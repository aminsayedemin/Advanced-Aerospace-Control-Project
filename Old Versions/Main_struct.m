...
% W2inv = tf(1);
W2inv = makeweight(0.4, [4 0.6], 0.83, Ts);
W2 = 1/W2inv;
...
% W3inv = makeweight(1.2, 20, 0.001, Ts);
% W3 = 1/W3inv;
% W3 = tf(0);
% W3.u = {'phi'};
% W3.y = {'z_3'};
...
% P = augw(G_nom, W1);
P = connect(Rp, W1, W2, Sum, Rphi, G_nom, {'phi_0'}, {'z_1', 'z_2', 'p', 'phi'});
% P = connect(Rp, W2, W3, Sum, Rphi, G_nom, {'phi_0'}, {'z_2', 'z_3'});
...
F = connect(G_nom, Rp, Rphi, Sum, {'phi_0'}, {'phi'});
% figure
% bode(F, W3inv);
% grid on;
% legend('Loop', '1/W3');
